...
module.exports = function exportResume(fileName, program, callback) {
  ...
  var contents = fs.readFileSync(resumeFileName);
  // Define to JSON type
  var resumeJson = JSON.parse(contents);

  // resumeJsonData =
  //   '{"basics":{"name":"farid aliev","label":"registered","picture":"","email":"alfarid23+foo@gmail.com","phone":"123123123","website":"","summary":"","location":{"address":"","postalCode":"","city":"San Francisco","countryCode":"United States","region":"CA"}}}';
  // var resumeJson = JSON.parse(resumeJsonData);
